...
/**
 * HighlightApi Class Doc Comment
 *
 * @category Class
 * @package  Immodvisor
 * @author   Swagger Codegen team
...
class HighlightApi
{
     ...
     * @return \Immodvisor\Model\InlineResponse20019
     */
    public function highlightListGet($checksum, $aPIVERSION, $companyId = null, $companyCustomId = null)
    {
        list($response) = $this->highlightListGetWithHttpInfo($checksum, $aPIVERSION, $companyId, $companyCustomId);
        return $response;
    }

    /**
     * Operation highlightListGetWithHttpInfo
     *
     * Get custom questionnaires list
     *
     * @param  string $checksum Request&#x27;s validity checksum (required)
     ...
     * @throws \Immodvisor\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Immodvisor\Model\InlineResponse20019, HTTP status code, HTTP response headers (array of strings)
     */
    public function highlightListGetWithHttpInfo($checksum, $aPIVERSION, $companyId = null, $companyCustomId = null)
    {
        $returnType = '\Immodvisor\Model\InlineResponse20019';
        $request = $this->highlightListGetRequest($checksum, $aPIVERSION, $companyId, $companyCustomId);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Immodvisor\Model\InlineResponse20019',
    ...
    /**
     * Operation highlightListGetAsync
     *
     * Get custom questionnaires list
     *
     * @param  string $checksum Request&#x27;s validity checksum (required)
     ...
     */
    public function highlightListGetAsync($checksum, $aPIVERSION, $companyId = null, $companyCustomId = null)
    {
        return $this->highlightListGetAsyncWithHttpInfo($checksum, $aPIVERSION, $companyId, $companyCustomId)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation highlightListGetAsyncWithHttpInfo
     *
     * Get custom questionnaires list
     *
     * @param  string $checksum Request&#x27;s validity checksum (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function highlightListGetAsyncWithHttpInfo($checksum, $aPIVERSION, $companyId = null, $companyCustomId = null)
    {
        $returnType = '\Immodvisor\Model\InlineResponse20019';
        $request = $this->highlightListGetRequest($checksum, $aPIVERSION, $companyId, $companyCustomId);
    ...
    /**
     * Create request for operation 'highlightListGet'
     *
     * @param  string $checksum Request&#x27;s validity checksum (required)
     * @param  string $aPIVERSION API&#x27;s Used version. (required)
     * @param  int $companyId unique Immodvisor company ID (optional)
     ...
     */
    protected function highlightListGetRequest($checksum, $aPIVERSION, $companyId = null, $companyCustomId = null)
    {
        // verify the required parameter 'checksum' is set
        if ($checksum === null || (is_array($checksum) && count($checksum) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $checksum when calling highlightListGet'
            );
        }
        // verify the required parameter 'aPIVERSION' is set
        if ($aPIVERSION === null || (is_array($aPIVERSION) && count($aPIVERSION) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $aPIVERSION when calling highlightListGet'
            );
        }

        $resourcePath = '/highlight/list';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
