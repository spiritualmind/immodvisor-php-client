...
class UtilsApi
{
     ...
     * @return \Immodvisor\Model\InlineResponse2008
     */
    public function configGet($checksum, $aPIVERSION)
    {
        list($response) = $this->configGetWithHttpInfo($checksum, $aPIVERSION);
        return $response;
    }
     ...
     * @throws \Immodvisor\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Immodvisor\Model\InlineResponse2008, HTTP status code, HTTP response headers (array of strings)
     */
    public function configGetWithHttpInfo($checksum, $aPIVERSION)
    {
        $returnType = '\Immodvisor\Model\InlineResponse2008';
        $request = $this->configGetRequest($checksum, $aPIVERSION);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Immodvisor\Model\InlineResponse2008',
     ...
     */
    public function configGetAsync($checksum, $aPIVERSION)
    {
        return $this->configGetAsyncWithHttpInfo($checksum, $aPIVERSION)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function configGetAsyncWithHttpInfo($checksum, $aPIVERSION)
    {
        $returnType = '\Immodvisor\Model\InlineResponse2008';
        $request = $this->configGetRequest($checksum, $aPIVERSION);
     ...
     */
    protected function configGetRequest($checksum, $aPIVERSION)
    {
        // verify the required parameter 'checksum' is set
        if ($checksum === null || (is_array($checksum) && count($checksum) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $checksum when calling configGet'
            );
        }
        // verify the required parameter 'aPIVERSION' is set
        if ($aPIVERSION === null || (is_array($aPIVERSION) && count($aPIVERSION) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $aPIVERSION when calling configGet'
            );
        }
     ...
     * @throws \Immodvisor\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Immodvisor\Model\InlineResponse2009
     */
    public function mapDepartmentsGet($checksum, $aPIVERSION)
    {
        list($response) = $this->mapDepartmentsGetWithHttpInfo($checksum, $aPIVERSION);
        return $response;
    }

    /**
     * Operation mapDepartmentsGetWithHttpInfo
     *
     * Get departments' list
     *
     * @param  string $checksum Request&#x27;s validity checksum (required)
     ...
     * @throws \Immodvisor\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Immodvisor\Model\InlineResponse2009, HTTP status code, HTTP response headers (array of strings)
     */
    public function mapDepartmentsGetWithHttpInfo($checksum, $aPIVERSION)
    {
        $returnType = '\Immodvisor\Model\InlineResponse2009';
        $request = $this->mapDepartmentsGetRequest($checksum, $aPIVERSION);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Immodvisor\Model\InlineResponse2009',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation mapDepartmentsGetAsync
     *
     * Get departments' list
     *
     * @param  string $checksum Request&#x27;s validity checksum (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function mapDepartmentsGetAsync($checksum, $aPIVERSION)
    {
        return $this->mapDepartmentsGetAsyncWithHttpInfo($checksum, $aPIVERSION)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation mapDepartmentsGetAsyncWithHttpInfo
     *
     * Get departments' list
     *
     * @param  string $checksum Request&#x27;s validity checksum (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function mapDepartmentsGetAsyncWithHttpInfo($checksum, $aPIVERSION)
    {
        $returnType = '\Immodvisor\Model\InlineResponse2009';
        $request = $this->mapDepartmentsGetRequest($checksum, $aPIVERSION);
    ...
    /**
     * Create request for operation 'mapDepartmentsGet'
     *
     * @param  string $checksum Request&#x27;s validity checksum (required)
     * @param  string $aPIVERSION API&#x27;s Used version. (required)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function mapDepartmentsGetRequest($checksum, $aPIVERSION)
    {
        // verify the required parameter 'checksum' is set
        if ($checksum === null || (is_array($checksum) && count($checksum) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $checksum when calling mapDepartmentsGet'
            );
        }
        // verify the required parameter 'aPIVERSION' is set
        if ($aPIVERSION === null || (is_array($aPIVERSION) && count($aPIVERSION) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $aPIVERSION when calling mapDepartmentsGet'
            );
        }

        $resourcePath = '/map/departments';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     */
    public function testGet($checksum, $aPIVERSION)
    {
        list($response) = $this->testGetWithHttpInfo($checksum, $aPIVERSION);
        return $response;
    }
     ...
     */
    public function testGetWithHttpInfo($checksum, $aPIVERSION)
    {
        $returnType = '\Immodvisor\Model\InlineResponse2004';
        $request = $this->testGetRequest($checksum, $aPIVERSION);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function testGetAsync($checksum, $aPIVERSION)
    {
        return $this->testGetAsyncWithHttpInfo($checksum, $aPIVERSION)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function testGetAsyncWithHttpInfo($checksum, $aPIVERSION)
    {
        $returnType = '\Immodvisor\Model\InlineResponse2004';
        $request = $this->testGetRequest($checksum, $aPIVERSION);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function testGetRequest($checksum, $aPIVERSION)
    {
        // verify the required parameter 'checksum' is set
        if ($checksum === null || (is_array($checksum) && count($checksum) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $checksum when calling testGet'
            );
        }
        // verify the required parameter 'aPIVERSION' is set
        if ($aPIVERSION === null || (is_array($aPIVERSION) && count($aPIVERSION) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $aPIVERSION when calling testGet'
            );
        }
