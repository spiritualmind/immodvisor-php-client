...
/**
 * CompanyAddpartnerBody Class Doc Comment
 *
 * @category Class
 * @package  Immodvisor
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CompanyAddpartnerBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'company_addpartner_body';
    ...
    const TYPE_IMMODVISOR = 'immodvisor';
     ...
     * Sets type
     *
     * @param string $type immodvisor or external, specifies if it is a partner customer of Immodvisor or other
     *
     * @return $this
     */
     ...
     * Sets url
     *
     * @param string $url url of the public file for the type immodvisor, optional parameter otherwise
     *
     * @return $this
     */
     ...
     * Sets logo
     *
     * @param string $logo Logo's file, mandatory for the external type, useless otherwise.
     *
     * @return $this
     */
