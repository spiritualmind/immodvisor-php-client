...
/**
 * CompanyAttributesBody Class Doc Comment
 *
 * @category Class
 * @package  Immodvisor
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CompanyAttributesBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'company_attributes_body';
     ...
     * Sets attributes
     *
     * @param object[] $attributes Google attribute table. To get the list of Google attributes see the endpoint : getactivity. example : attributes[has_wheelchair_accessible_entrance]=true The type of value to send for each attribute is specified in the endpoint.
     *
     * @return $this
     */
