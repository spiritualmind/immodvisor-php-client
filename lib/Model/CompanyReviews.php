...
/**
 * CompanyReviews Class Doc Comment
 *
 * @category Class
 * @description Company&#x27;s notices informations
 * @package  Immodvisor
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CompanyReviews implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'company_reviews';
    ...
    {
        $this->container['nbr'] = isset($data['nbr']) ? $data['nbr'] : null;
    ...
    {
        return $this->container['nbr'];
    }

    /**
     * Sets nbr
     *
     * @param int $nbr reviews number
     *
     * @return $this
     */
    public function setNbr($nbr)
    {
        $this->container['nbr'] = $nbr;
     ...
     * Sets recommended
     *
     * @param int $recommended Recommandations' number
     *
     * @return $this
     */
