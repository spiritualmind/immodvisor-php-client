...
/**
 * FolderCreateBody Class Doc Comment
 *
 * @category Class
 * @package  Immodvisor
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class FolderCreateBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'folder_create_body';
     ...
     * Sets companyId
     *
     * @param int $companyId Immodvisor company ID on which to create a folder
     *
     * @return $this
     */
     ...
     *
     * @param string $companyCustomId Your company's ID to create a folder.
     *
     * @return $this
     */
