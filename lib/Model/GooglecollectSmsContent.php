...
/**
 * GooglecollectSmsContent Class Doc Comment
 *
 * @category Class
 * @description Only in the case of sending text message (&#x27;sms&#x27;). If it is not filled in, Immodvisor will automatically fill it in an optimized content. This parameter is an array of two elements.
 * @package  Immodvisor
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GooglecollectSmsContent implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'googlecollect_sms_content';
     ...
     * Sets senderName
     *
     * @param string $senderName Name sent in the text message's title, without spaces and special characters.
     *
     * @return $this
     */
     ...
     * Sets message
     *
     * @param string $message Text message's content.
     *
     * @return $this
     */
