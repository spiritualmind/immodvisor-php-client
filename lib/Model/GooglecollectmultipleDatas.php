...
/**
 * GooglecollectmultipleDatas Class Doc Comment
 *
 * @category Class
 * @package  Immodvisor
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GooglecollectmultipleDatas implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'googlecollectmultiple_datas';
    ...
    protected static $swaggerTypes = [
        ...
        'mobile' => 'string',
        'type' => 'string',
        'smsContent' => '\Immodvisor\Model\GooglecollectSmsContent',
        'sendingDate' => 'string'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['sendingDate'] = isset($data['sendingDate']) ? $data['sendingDate'] : null;
    }
     ...
     * Sets companyId
     *
     * @param int $companyId unique Immodvisor company ID
     *
     * @return $this
     */
     ...
     *
     * @param string $companyCustomId Your unique company's ID.
     *
     * @return $this
     */
     ...
     * Sets mobile
     *
     * @param string $mobile Customer's mobile number. If present, the customer will receive a texting message instead of an email.
     *
     * @return $this
     */
     ...
     * Sets type
     *
     * @param string $type The default value is 'mail', if the value is 'sms' the mobile parameter becomes mandatory.
     *
     * @return $this
     */
     ...
     * Gets smsContent
     *
     * @return \Immodvisor\Model\GooglecollectSmsContent
     */
     ...
     * Sets smsContent
     *
     * @param \Immodvisor\Model\GooglecollectSmsContent $smsContent smsContent
     *
     * @return $this
     */
    ...
    {
        return $this->container['sendingDate'];
    }

    /**
     * Sets sendingDate
     *
     * @param string $sendingDate Date in dateTime format (YYYY-MM-DD hh:mm:ss) which determine the collection's sent date. If it is not filled in, the collection is sent at the earliest.
     *
     * @return $this
     */
    public function setSendingDate($sendingDate)
    {
        $this->container['sendingDate'] = $sendingDate;
