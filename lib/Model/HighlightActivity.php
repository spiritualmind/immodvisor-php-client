...
/**
 * HighlightActivity Class Doc Comment
 *
 * @category Class
 * @package  Immodvisor
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class HighlightActivity implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'highlight_activity';
     ...
     * Sets id
     *
     * @param int $id ID Immodvisor of the activity
     *
     * @return $this
     */
