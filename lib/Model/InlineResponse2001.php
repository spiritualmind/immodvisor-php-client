...
class InlineResponse2001 implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'status' => 'int',
        'error' => 'string',
        'datas' => '\Immodvisor\Model\InlineResponse2001Datas',
        'checksum' => 'string'
    ];
     ...
     * Gets datas
     *
     * @return \Immodvisor\Model\InlineResponse2001Datas
     */
     ...
     * Sets datas
     *
     * @param \Immodvisor\Model\InlineResponse2001Datas $datas datas
     *
     * @return $this
     */
