...
/**
 * InlineResponse20012Datas Class Doc Comment
 *
 * @category Class
 * @package  Immodvisor
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse20012Datas implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_200_12_datas';
    ...
    protected static $setters = [
        'nbrSents' => 'setNbrSents',
        'nbrDone' => 'setNbrDone',
        'nbrFails' => 'setNbrFails',
        'sents' => 'setSents'
    ];
    ...
    protected static $getters = [
        'nbrSents' => 'getNbrSents',
        'nbrDone' => 'getNbrDone',
        'nbrFails' => 'getNbrFails',
        'sents' => 'getSents'
    ];
    ...
    {
        $this->container['nbrSents'] = isset($data['nbrSents']) ? $data['nbrSents'] : null;
        $this->container['nbrDone'] = isset($data['nbrDone']) ? $data['nbrDone'] : null;
        $this->container['nbrFails'] = isset($data['nbrFails']) ? $data['nbrFails'] : null;
        $this->container['sents'] = isset($data['sents']) ? $data['sents'] : null;
    }
     ...
     * @return int
     */
    public function getNbrSents()
    {
        return $this->container['nbrSents'];
    }

    /**
     * Sets nbrSents
     *
     * @param int $nbrSents Shipping requests processed's number.
     *
     * @return $this
     */
    public function setNbrSents($nbrSents)
    {
        $this->container['nbrSents'] = $nbrSents;
    ...
    {
        return $this->container['nbrDone'];
    }

    /**
     * Sets nbrDone
     *
     * @param int $nbrDone Shipments made's number.
     *
     * @return $this
     */
    public function setNbrDone($nbrDone)
    {
        $this->container['nbrDone'] = $nbrDone;
     ...
     * @return int
     */
    public function getNbrFails()
    {
        return $this->container['nbrFails'];
    }

    /**
     * Sets nbrFails
     *
     * @param int $nbrFails Failed shipments' number.
     *
     * @return $this
     */
    public function setNbrFails($nbrFails)
    {
        $this->container['nbrFails'] = $nbrFails;
     ...
     * Gets sents
     *
     * @return \Immodvisor\Model\Sent[]
     */
    public function getSents()
    {
        return $this->container['sents'];
    }

    /**
     * Sets sents
     *
     * @param \Immodvisor\Model\Sent[] $sents sents
     *
     * @return $this
     */
    public function setSents($sents)
    {
        $this->container['sents'] = $sents;
