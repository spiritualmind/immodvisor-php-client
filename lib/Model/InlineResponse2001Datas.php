...
/**
 * InlineResponse2001Datas Class Doc Comment
 *
 * @category Class
 * @package  Immodvisor
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse2001Datas implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_200_1_datas';
    ...
    protected static $swaggerTypes = [
        'company' => '\Immodvisor\Model\Company',
        'nbrCompanies' => 'int',
        'companies' => '\Immodvisor\Model\Company[]',
        'nbrReviews' => 'int',
        'reviews' => '\Immodvisor\Model\Review[]'
    ];
    ...
    protected static $attributeMap = [
        'company' => 'company',
        'nbrCompanies' => 'nbr_companies',
        'companies' => 'companies',
        'nbrReviews' => 'nbr_reviews',
        'reviews' => 'reviews'
    ];
    ...
    protected static $setters = [
        'company' => 'setCompany',
        'nbrCompanies' => 'setNbrCompanies',
        'companies' => 'setCompanies',
        'nbrReviews' => 'setNbrReviews',
        'reviews' => 'setReviews'
    ];
    ...
    protected static $getters = [
        'company' => 'getCompany',
        'nbrCompanies' => 'getNbrCompanies',
        'companies' => 'getCompanies',
        'nbrReviews' => 'getNbrReviews',
        'reviews' => 'getReviews'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['nbrCompanies'] = isset($data['nbrCompanies']) ? $data['nbrCompanies'] : null;
        $this->container['companies'] = isset($data['companies']) ? $data['companies'] : null;
        $this->container['nbrReviews'] = isset($data['nbrReviews']) ? $data['nbrReviews'] : null;
     ...
     * Gets company
     *
     * @return \Immodvisor\Model\Company
     */
     ...
     * Sets company
     *
     * @param \Immodvisor\Model\Company $company company
     *
     * @return $this
     */
     ...
     * @return int
     */
    public function getNbrCompanies()
    {
        return $this->container['nbrCompanies'];
    }

    /**
     * Sets nbrCompanies
     *
     * @param int $nbrCompanies Company's children associated with the brand number
     *
     * @return $this
     */
    public function setNbrCompanies($nbrCompanies)
    {
        $this->container['nbrCompanies'] = $nbrCompanies;
     ...
     * Sets companies
     *
     * @param \Immodvisor\Model\Company[] $companies companies
     *
     * @return $this
     */
     ...
     * @return int
     */
    public function getNbrReviews()
    {
        return $this->container['nbrReviews'];
    }

    /**
     * Sets nbrReviews
     *
     * @param int $nbrReviews Number of review returned relating to companies associated with the brand
     *
     * @return $this
     */
    public function setNbrReviews($nbrReviews)
    {
        $this->container['nbrReviews'] = $nbrReviews;
     ...
     * Gets reviews
     *
     * @return \Immodvisor\Model\Review[]
     */
     ...
     * Sets reviews
     *
     * @param \Immodvisor\Model\Review[] $reviews Only if nbr_reviews parameter is specify.
     *
     * @return $this
     */
