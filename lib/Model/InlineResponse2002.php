...
class InlineResponse2002 implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'status' => 'int',
        'error' => 'string',
        'datas' => '\Immodvisor\Model\InlineResponse2002Datas',
        'checksum' => 'string'
    ];
     ...
     * Gets datas
     *
     * @return \Immodvisor\Model\InlineResponse2002Datas
     */
     ...
     * Sets datas
     *
     * @param \Immodvisor\Model\InlineResponse2002Datas $datas datas
     *
     * @return $this
     */
