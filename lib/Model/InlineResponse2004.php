...
class InlineResponse2004 implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'status' => 'int',
        'error' => 'string',
        'datas' => '\Immodvisor\Model\InlineResponse2004Datas',
        'checksum' => 'string'
    ];
     ...
     * Gets datas
     *
     * @return \Immodvisor\Model\InlineResponse2004Datas
     */
     ...
     * Sets datas
     *
     * @param \Immodvisor\Model\InlineResponse2004Datas $datas datas
     *
     * @return $this
     */
