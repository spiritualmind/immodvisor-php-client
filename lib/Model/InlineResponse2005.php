...
class InlineResponse2005 implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'status' => 'int',
        'error' => 'string',
        'datas' => '\Immodvisor\Model\InlineResponse2005Datas',
        'checksum' => 'string'
    ];
     ...
     * Gets datas
     *
     * @return \Immodvisor\Model\InlineResponse2005Datas
     */
     ...
     * Sets datas
     *
     * @param \Immodvisor\Model\InlineResponse2005Datas $datas datas
     *
     * @return $this
     */
