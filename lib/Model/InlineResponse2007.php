...
class InlineResponse2007 implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'status' => 'int',
        'error' => 'string',
        'datas' => '\Immodvisor\Model\InlineResponse2007Datas',
        'checksum' => 'string'
    ];
     ...
     * Gets datas
     *
     * @return \Immodvisor\Model\InlineResponse2007Datas
     */
     ...
     * Sets datas
     *
     * @param \Immodvisor\Model\InlineResponse2007Datas $datas datas
     *
     * @return $this
     */
