...
/**
 * InlineResponse2007Datas Class Doc Comment
 *
 * @category Class
 * @package  Immodvisor
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse2007Datas implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_200_7_datas';
    ...
    {
        $this->container['nbrPros'] = isset($data['nbrPros']) ? $data['nbrPros'] : null;
     ...
     * @return int
     */
    public function getNbrPros()
    {
        return $this->container['nbrPros'];
    }

    /**
     * Sets nbrPros
     *
     * @param int $nbrPros number of pros
     *
     * @return $this
     */
    public function setNbrPros($nbrPros)
    {
        $this->container['nbrPros'] = $nbrPros;
     ...
     * Sets pros
     *
     * @param \Immodvisor\Model\Pro[] $pros pros
     *
     * @return $this
     */
