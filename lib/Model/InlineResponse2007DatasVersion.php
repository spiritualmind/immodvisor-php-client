<?php
/**
 * InlineResponse2007DatasVersion
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * InlineResponse2007DatasVersion Class Doc Comment
 *
 * @category Class
 * @package  Immodvisor
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse2007DatasVersion implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_200_7_datas_version';
     ...
     * Sets current
     *
     * @param string $current current version of the API
     *
     * @return $this
     */
     ...
     * Sets used
     *
     * @param string $used Used version.
     *
     * @return $this
     */
