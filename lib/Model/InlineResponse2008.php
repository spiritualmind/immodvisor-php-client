...
class InlineResponse2008 implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'status' => 'int',
        'error' => 'string',
        'datas' => '\Immodvisor\Model\InlineResponse2008Datas',
        'checksum' => 'string'
    ];
     ...
     * Gets datas
     *
     * @return \Immodvisor\Model\InlineResponse2008Datas
     */
     ...
     * Sets datas
     *
     * @param \Immodvisor\Model\InlineResponse2008Datas $datas datas
     *
     * @return $this
     */
