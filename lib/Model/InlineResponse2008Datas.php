...
/**
 * InlineResponse2008Datas Class Doc Comment
 *
 * @category Class
 * @package  Immodvisor
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse2008Datas implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_200_8_datas';
    ...
    protected static $swaggerTypes = [
        ...
        'apiKey' => 'string',
        'ips' => 'string[]',
        'saltChecksumIn' => 'string',
        'saltChecksumOut' => 'string',
        'version' => '\Immodvisor\Model\InlineResponse2008DatasVersion',
        'contact' => '\Immodvisor\Model\InlineResponse2008DatasContact'
    ];
    ...
    protected static $attributeMap = [
        ...
        'apiKey' => 'api_key',
        'ips' => 'ips',
        'saltChecksumIn' => 'salt_checksum_in',
        'saltChecksumOut' => 'salt_checksum_out',
        'version' => 'version',
        'contact' => 'contact'
    ];
    ...
    protected static $setters = [
        ...
        'apiKey' => 'setApiKey',
        'ips' => 'setIps',
        'saltChecksumIn' => 'setSaltChecksumIn',
        'saltChecksumOut' => 'setSaltChecksumOut',
        'version' => 'setVersion',
        'contact' => 'setContact'
    ];
    ...
    protected static $getters = [
        ...
        'apiKey' => 'getApiKey',
        'ips' => 'getIps',
        'saltChecksumIn' => 'getSaltChecksumIn',
        'saltChecksumOut' => 'getSaltChecksumOut',
        'version' => 'getVersion',
        'contact' => 'getContact'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['saltChecksumIn'] = isset($data['saltChecksumIn']) ? $data['saltChecksumIn'] : null;
        $this->container['saltChecksumOut'] = isset($data['saltChecksumOut']) ? $data['saltChecksumOut'] : null;
     ...
     * Sets idCompany
     *
     * @param int $idCompany Company's identifier associated with the API key.
     *
     * @return $this
     */
     ...
     * @return string
     */
    public function getSaltChecksumIn()
    {
        return $this->container['saltChecksumIn'];
    }

    /**
     * Sets saltChecksumIn
     *
     * @param string $saltChecksumIn salt checksum in for call
     *
     * @return $this
     */
    public function setSaltChecksumIn($saltChecksumIn)
    {
        $this->container['saltChecksumIn'] = $saltChecksumIn;

        return $this;
    }

    /**
     * Gets saltChecksumOut
     *
     * @return string
     */
    public function getSaltChecksumOut()
    {
        return $this->container['saltChecksumOut'];
    }

    /**
     * Sets saltChecksumOut
     *
     * @param string $saltChecksumOut salt checksum out for call
     *
     * @return $this
     */
    public function setSaltChecksumOut($saltChecksumOut)
    {
        $this->container['saltChecksumOut'] = $saltChecksumOut;
     ...
     * Gets version
     *
     * @return \Immodvisor\Model\InlineResponse2008DatasVersion
     */
     ...
     * Sets version
     *
     * @param \Immodvisor\Model\InlineResponse2008DatasVersion $version version
     *
     * @return $this
     */
     ...
     * Gets contact
     *
     * @return \Immodvisor\Model\InlineResponse2008DatasContact
     */
     ...
     * Sets contact
     *
     * @param \Immodvisor\Model\InlineResponse2008DatasContact $contact contact
     *
     * @return $this
     */
