...
class InlineResponse2009 implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'status' => 'int',
        'error' => 'string',
        'datas' => '\Immodvisor\Model\InlineResponse2009Datas',
        'checksum' => 'string'
    ];
     ...
     * Gets datas
     *
     * @return \Immodvisor\Model\InlineResponse2009Datas
     */
     ...
     * Sets datas
     *
     * @param \Immodvisor\Model\InlineResponse2009Datas $datas datas
     *
     * @return $this
     */
