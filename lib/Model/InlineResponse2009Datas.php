...
/**
 * InlineResponse2009Datas Class Doc Comment
 *
 * @category Class
 * @package  Immodvisor
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse2009Datas implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_200_9_datas';
    ...
    protected static $swaggerTypes = [
        'nbrDepartments' => 'int',
        'departements' => '\Immodvisor\Model\Departement[]'
    ];
    ...
    protected static $attributeMap = [
        'nbrDepartments' => 'nbr_departments',
    ...
    protected static $setters = [
        'nbrDepartments' => 'setNbrDepartments',
        'departements' => 'setDepartements'
    ];
    ...
    protected static $getters = [
        'nbrDepartments' => 'getNbrDepartments',
    ...
    {
        $this->container['nbrDepartments'] = isset($data['nbrDepartments']) ? $data['nbrDepartments'] : null;
        $this->container['departements'] = isset($data['departements']) ? $data['departements'] : null;
    }
     ...
     * @return int
     */
    public function getNbrDepartments()
    {
        return $this->container['nbrDepartments'];
    }

    /**
     * Sets nbrDepartments
     *
     * @param int $nbrDepartments number departements returned
     *
     * @return $this
     */
    public function setNbrDepartments($nbrDepartments)
    {
        $this->container['nbrDepartments'] = $nbrDepartments;
     ...
     * Gets departements
     *
     * @return \Immodvisor\Model\Departement[]
     */
    public function getDepartements()
    {
        return $this->container['departements'];
    }

    /**
     * Sets departements
     *
     * @param \Immodvisor\Model\Departement[] $departements departements
     *
     * @return $this
     */
    public function setDepartements($departements)
    {
        $this->container['departements'] = $departements;
