...
class OpeningTime implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'opening_time';
    ...
    protected static $swaggerTypes = [
        'morningStart' => 'string',
        'morningStop' => 'string',
        'morningAppointment' => 'bool',
        'afternoonStart' => 'string',
        'afternoonStop' => 'string',
        'afternoonAppointment' => 'bool'
    ];
    ...
    protected static $attributeMap = [
        ...
        'morningStop' => 'morning_stop',
        'morningAppointment' => 'morning_appointment',
        'afternoonStart' => 'afternoon_start',
        'afternoonStop' => 'afternoon_stop',
        'afternoonAppointment' => 'afternoon_appointment'
    ];
    ...
    protected static $setters = [
        ...
        'morningStop' => 'setMorningStop',
        'morningAppointment' => 'setMorningAppointment',
        'afternoonStart' => 'setAfternoonStart',
        'afternoonStop' => 'setAfternoonStop',
        'afternoonAppointment' => 'setAfternoonAppointment'
    ];
    ...
    protected static $getters = [
        'morningStart' => 'getMorningStart',
        'morningStop' => 'getMorningStop',
        'morningAppointment' => 'getMorningAppointment',
        'afternoonStart' => 'getAfternoonStart',
        'afternoonStop' => 'getAfternoonStop',
        'afternoonAppointment' => 'getAfternoonAppointment'
    ];
    ...
    {
        $this->container['morningStart'] = isset($data['morningStart']) ? $data['morningStart'] : null;
        $this->container['morningStop'] = isset($data['morningStop']) ? $data['morningStop'] : null;
        $this->container['morningAppointment'] = isset($data['morningAppointment']) ? $data['morningAppointment'] : null;
        $this->container['afternoonStart'] = isset($data['afternoonStart']) ? $data['afternoonStart'] : null;
        $this->container['afternoonStop'] = isset($data['afternoonStop']) ? $data['afternoonStop'] : null;
        $this->container['afternoonAppointment'] = isset($data['afternoonAppointment']) ? $data['afternoonAppointment'] : null;
    }
     ...
     * @return string
     */
    public function getMorningStart()
    {
        return $this->container['morningStart'];
    }

    /**
     * Sets morningStart
     *
     * @param string $morningStart opening hours in the morning
     *
     * @return $this
     */
    public function setMorningStart($morningStart)
    {
        $this->container['morningStart'] = $morningStart;
     ...
     * @return string
     */
    public function getMorningStop()
    {
        return $this->container['morningStop'];
    }

    /**
     * Sets morningStop
     *
     * @param string $morningStop closing time in the morning
     *
     * @return $this
     */
    public function setMorningStop($morningStop)
    {
        $this->container['morningStop'] = $morningStop;

        return $this;
    }

    /**
     * Gets morningAppointment
     *
     * @return bool
     */
    public function getMorningAppointment()
    {
        return $this->container['morningAppointment'];
    }

    /**
     * Sets morningAppointment
     *
     * @param bool $morningAppointment open in the morning by appointment only
     *
     * @return $this
     */
    public function setMorningAppointment($morningAppointment)
    {
        $this->container['morningAppointment'] = $morningAppointment;
     ...
     * @return string
     */
    public function getAfternoonStart()
    {
        return $this->container['afternoonStart'];
    }

    /**
     * Sets afternoonStart
     *
     * @param string $afternoonStart afternoon opening time
     *
     * @return $this
     */
    public function setAfternoonStart($afternoonStart)
    {
        $this->container['afternoonStart'] = $afternoonStart;
     ...
     * @return string
     */
    public function getAfternoonStop()
    {
        return $this->container['afternoonStop'];
    }

    /**
     * Sets afternoonStop
     *
     * @param string $afternoonStop closing time in the afternoon
     *
     * @return $this
     */
    public function setAfternoonStop($afternoonStop)
    {
        $this->container['afternoonStop'] = $afternoonStop;

        return $this;
    }

    /**
     * Gets afternoonAppointment
     *
     * @return bool
     */
    public function getAfternoonAppointment()
    {
        return $this->container['afternoonAppointment'];
    }

    /**
     * Sets afternoonAppointment
     *
     * @param bool $afternoonAppointment open in the afternoon by appointment only
     *
     * @return $this
     */
    public function setAfternoonAppointment($afternoonAppointment)
    {
        $this->container['afternoonAppointment'] = $afternoonAppointment;
