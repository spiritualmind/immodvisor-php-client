...
/**
 * ProCompanies Class Doc Comment
 *
 * @category Class
 * @package  Immodvisor
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ProCompanies implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'pro_companies';
     ...
     * Sets id
     *
     * @param int $id ID of the company associated
     *
     * @return $this
     */
