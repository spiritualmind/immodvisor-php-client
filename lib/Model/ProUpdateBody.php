...
/**
 * ProUpdateBody Class Doc Comment
 *
 * @category Class
 * @package  Immodvisor
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ProUpdateBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'pro_update_body';
     ...
     * Sets id
     *
     * @param int $id unique Immodvisor identifier of the pro
     *
     * @return $this
     */
     ...
     * Sets aclAapp
     *
     * @param bool $aclAapp access authorization to the Immodvisor PRO application
     *
     * @return $this
     */
     ...
     * Sets aclPro
     *
     * @param bool $aclPro access authorization to the PRO area
     *
     * @return $this
     */
