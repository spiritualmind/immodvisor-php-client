...
/**
 * ReviewAnswer Class Doc Comment
 *
 * @category Class
 * @package  Immodvisor
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ReviewAnswer implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'review_answer';
     ...
     * Sets id
     *
     * @param string $id answer identifier
     *
     * @return $this
     */
     ...
     * Sets job
     *
     * @param string $job job of the person who answered
     *
     * @return $this
     */
     ...
     * Sets signature
     *
     * @param string $signature name of the person who answered
     *
     * @return $this
     */
     ...
     * Sets date
     *
     * @param string $date date of the answer
     *
     * @return $this
     */
