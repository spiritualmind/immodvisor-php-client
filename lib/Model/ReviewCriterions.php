...
/**
 * ReviewCriterions Class Doc Comment
 *
 * @category Class
 * @package  Immodvisor
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ReviewCriterions implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'review_criterions';
     ...
     * Sets id
     *
     * @param int $id criterion identifier
     *
     * @return $this
     */
     ...
     * Sets rating
     *
     * @param int $rating rating assigned by the depository
     *
     * @return $this
     */
