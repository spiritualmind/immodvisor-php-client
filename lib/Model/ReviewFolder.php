...
/**
 * ReviewFolder Class Doc Comment
 *
 * @category Class
 * @package  Immodvisor
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ReviewFolder implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'review_folder';
     ...
     * Sets id
     *
     * @param int $id Folder's identifier.
     *
     * @return $this
     */
     ...
     * Sets reference
     *
     * @param string $reference your Folder's reference
     *
     * @return $this
     */
