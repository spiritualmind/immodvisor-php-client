...
/**
 * ReviewHighlight Class Doc Comment
 *
 * @category Class
 * @package  Immodvisor
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ReviewHighlight implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'review_highlight';
     ...
     * Sets id
     *
     * @param int $id highlight identifier
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name name of personalized questionnaire
     *
     * @return $this
     */
