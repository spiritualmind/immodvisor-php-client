...
/**
 * ReviewUpdateanswerBody Class Doc Comment
 *
 * @category Class
 * @package  Immodvisor
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ReviewUpdateanswerBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'review_updateanswer_body';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['answerId'] === null) {
            $invalidProperties[] = "'answerId' can't be null";
        }
     ...
     * Sets answerId
     *
     * @param int $answerId unique Immodvisor identifier of the answer
     *
     * @return $this
     */
     ...
     * Sets job
     *
     * @param string $job profession of the professional who provides the answer
     *
     * @return $this
     */
     ...
     * Sets signature
     *
     * @param string $signature signature of the professional who provides the answer
     *
     * @return $this
     */
