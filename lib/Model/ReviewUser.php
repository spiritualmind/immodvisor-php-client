 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ReviewUser implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'review_user';
     ...
     * Sets login
     *
     * @param string $login depositor's nickname
     *
     * @return $this
     */
     ...
     * Sets color
     *
     * @param string $color nickname color
     *
     * @return $this
     */
     ...
     * Sets email
     *
     * @param string $email e-mail from the depository
     *
     * @return $this
     */
     ...
     * Sets mobile
     *
     * @param string $mobile mobile number of the depository
     *
     * @return $this
     */
