 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Sent implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'sent';
     ...
     * Sets row
     *
     * @param int $row processed line number (starts at 1)
     *
     * @return $this
     */
     ...
     * Sets email
     *
     * @param string $email relevant email address
     *
     * @return $this
     */
     ...
     * Sets state
     *
     * @param bool $state 1=Success, 0=error
     *
     * @return $this
     */
     ...
     * Sets error
     *
     * @param string $error if error state=0
     *
     * @return $this
     */
