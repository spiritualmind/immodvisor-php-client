...
class Service implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['idActivity'] = isset($data['idActivity']) ? $data['idActivity'] : null;
    ...
    {
        return $this->container['idActivity'];
    }

    /**
     * Sets idActivity
     *
     * @param int $idActivity activity's id
     *
     * @return $this
     */
    public function setIdActivity($idActivity)
    {
        $this->container['idActivity'] = $idActivity;
