...
/**
 * TeamCreateBody Class Doc Comment
 *
 * @category Class
 * @package  Immodvisor
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TeamCreateBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'team_create_body';
     ...
     * Sets companyId
     *
     * @param int $companyId Immodvisor identify of the company on which to create a team
     *
     * @return $this
     */
     ...
     *
     * @param string $companyCustomId Your company's ID to create a team.
     *
     * @return $this
     */
     ...
     * Sets customId
     *
     * @param string $customId team's ID
     *
     * @return $this
     */
