...
/**
 * TeamProlinkBody Class Doc Comment
 *
 * @category Class
 * @package  Immodvisor
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TeamProlinkBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'team_prolink_body';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['proId'] === null) {
            $invalidProperties[] = "'proId' can't be null";
        }
     ...
     * Sets customId
     *
     * @param string $customId your team ID
     *
     * @return $this
     */
     ...
     * Sets proId
     *
     * @param string $proId Pro's identifier to associate.
     *
     * @return $this
     */
     ...
     * Sets proCustomId
     *
     * @param string $proCustomId Yours unique Pro's identifier to associate.
     *
     * @return $this
     */
