 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TeamPros implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'team_pros';
     ...
     * Sets id
     *
     * @param int $id ID Immodvisor of the pro linked to the team
     *
     * @return $this
     */
     ...
     * Sets customId
     *
     * @param string $customId your pro ID
     *
     * @return $this
     */
