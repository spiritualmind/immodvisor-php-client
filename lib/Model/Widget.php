 ...
 *
 * @category Class
 * @description login to the company&#x27;s widget
 * @package  Immodvisor
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Widget implements ModelInterface, ArrayAccess
{
     ...
     * Sets key
     *
     * @param string $key widget's api key
     *
     * @return $this
     */
     ...
     * Sets hash
     *
     * @param string $hash Widget's hash
     *
     * @return $this
     */
     ...
     * Sets domains
     *
     * @param string[] $domains list of domains authorized to display them
     *
     * @return $this
     */
